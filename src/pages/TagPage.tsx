import { ArrowLeft, Luggage, ExternalLink } from 'lucide-react'

/**
 * Tag Generator ialah aplikasi statik berasingan yang dihidangkan dari
 * `docs/tag/`. Sama seperti alat-alat lain, ia dimuatkan dalam iframe supaya
...
export const TagPage = () => (
  <div className="flex h-[100svh] flex-col bg-canvas">
    <header className="shrink-0 bg-surface">
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <span
            className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#eef4fd] sm:inline-flex"
            aria-hidden="true"
          >
            <Luggage className="h-5 w-5 text-[#2f5db0]" />
          </span>
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted sm:text-sm">
              Tag beg dengan slot tali, muka depan dan belakang
            </p>
          </div>
        </div>
        <a
    ...
    <iframe
      src="/tag/"
      title="Tag Generator — penjana tag beg untuk laser"
