...
/**
 * Rehal Generator ialah aplikasi statik berasingan yang dihidangkan dari
 * `docs/rehal/`. Sama seperti alat-alat lain, ia dimuatkan dalam iframe supaya
 * jenama dan navigasi SifuLaser kekal.
 *
 * BookOpenText dan bukan BookOpen: BookOpen sudah menjadi glif kumpulan
 * "Belajar & Sumber" di halaman utama, dan dua benda berlainan dengan glif yang
 * sama pada satu halaman ialah salah baca, bukan penjimatan.
 */
export const RehalPage = () => (
  <div className="flex h-[100svh] flex-col bg-canvas">
    <header className="shrink-0 bg-surface">
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <span
            className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#f7f0e0] sm:inline-flex"
            aria-hidden="true"
          >
            <BookOpenText className="h-5 w-5 text-[#8a6a1f]" />
          </span>
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted sm:text-sm">
              Rehal Al-Quran boleh lipat — corak geometri dan nama terukir
            </p>
          </div>
        </div>
        <a
    ...
    <iframe
      src="/rehal/"
      title="Rehal Generator — penjana rehal Al-Quran berukir untuk laser"
