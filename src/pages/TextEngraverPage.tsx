...
/**
 * Text Engraver ialah aplikasi statik berasingan yang dihidangkan dari
 * `docs/text/`. Sama seperti Box Maker dan Puzzle Generator, ia dimuatkan
 * dalam iframe supaya jenama dan navigasi SifuLaser kekal.
 */
export const TextEngraverPage = () => (
  <div className="flex h-[100svh] flex-col bg-canvas">
    <header className="shrink-0 bg-surface">
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <span
            className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#fdf1e7] sm:inline-flex"
            aria-hidden="true"
          >
            <PenLine className="h-5 w-5 text-[#c2610f]" />
          </span>
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted sm:text-sm">
              Teks satu garisan untuk ukiran laju — SVG dan PDF
            </p>
          </div>
        </div>
        <a
    ...
    <iframe
      src="/text/"
      title="Text Engraver — penjana teks satu garisan"
