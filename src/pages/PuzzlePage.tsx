...
/**
 * Puzzle Generator ialah aplikasi statik berasingan yang dihidangkan dari
 * `docs/puzzle/`. Sama seperti Box Maker, ia dimuatkan dalam iframe supaya
...
export const PuzzlePage = () => (
  <div className="flex h-[100svh] flex-col bg-canvas">
    <header className="shrink-0 bg-surface">
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <span
            className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#eaf6f8] sm:inline-flex"
            aria-hidden="true"
          >
            <Puzzle className="h-5 w-5 text-[#0d7c8f]" />
          </span>
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted sm:text-sm">
              Jana garisan potong jigsaw ikut saiz papan anda
            </p>
          </div>
        </div>
        <a
    ...
    <iframe
      src="/puzzle/"
      title="Puzzle Generator — penjana garisan potong jigsaw"
