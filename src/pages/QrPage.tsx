...
/**
 * QR Generator ialah aplikasi statik berasingan yang dihidangkan dari
 * `docs/qr/`. Sama seperti Box Maker, Puzzle Generator, Text Engraver dan
 * Stand Nama, ia dimuatkan dalam iframe supaya jenama dan navigasi SifuLaser
 * kekal.
 */
export const QrPage = () => (
  <div className="flex h-[100svh] flex-col bg-canvas">
    <header className="shrink-0 bg-surface">
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <span
            className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#eef7f1] sm:inline-flex"
            aria-hidden="true"
          >
            <QrCode className="h-5 w-5 text-[#2f7d4f]" />
          </span>
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted sm:text-sm">
              Kod QR untuk laser — saiz mm sebenar, dengan amaran modul terlalu halus
            </p>
          </div>
        </div>
        <a
    ...
    <iframe
      src="/qr/"
      title="QR Generator — penjana kod QR untuk laser"
