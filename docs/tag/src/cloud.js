 ...
 * carry raw geometry rather than settings - this one keeps the sampled outline
 * of every imported SVG - and Firestore wraps each value in its own type
...
export async function save({
  ...
  const body = {
    fields: toFields({
      name: String(name || 'Untitled tag').slice(0, 120),
